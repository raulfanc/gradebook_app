...
1. developped models.py
 - 5  entities created according to [improvement 1](./models.py#improvement1) and [ERD](./ERD.png) apart from `enrolment`

2. updated models.py
 - 10 entities now according to [improvement 2](./models.py#improvement2)
...
- improved the models.py again according to [improvement 3](./models.py#improvement3)
